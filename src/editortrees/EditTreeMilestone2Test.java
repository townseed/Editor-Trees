...
//		t.show(); while(true) {}
	...
	public void test272AddManyRandom() {
		...
		// TODO: change to new Random(17), new Random(50), or whatever you find convenient while debugging 
		...
		for (int k = 0; k < NUM_NODES / SKIP_INTERVAL; k++) {
			for (int j = 0; j < 10; j++) {
				...
				// that you need to track down. Just remember to comment it out again when you're done,
				// since these checks take a very long time to finish.
